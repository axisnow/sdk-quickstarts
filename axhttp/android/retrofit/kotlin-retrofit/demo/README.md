...
本快速接入文档面向使用 Kotlin 开发、并通过 Retrofit 发起需要 SDK 保护的 API 调用的原生 Android 应用。如果你的场景不符，请查看其他更适合的快速接入文档。

本页提供了将 SDK 集成到你的应用中的全部步骤。此外，我们还提供了基于 [kotlin-retrofit-demo](kotlin-retrofit-demo/) 的分步教程示例。
